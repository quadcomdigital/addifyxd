...
class ADDF_GIFT_REGISTRY_PRODUCT_PURCHASE_WP_MAIL_ADMIN extends WC_Email {
	public function __construct() {
		$this->id             = 'addf_gr_product_purchase_wp_email_admin';
		$this->title          = __( 'Gift Registry', 'addf_giftr' );
		$this->customer_email = true;
		$this->description    = __( 'This mail will send to admin whenever a product is purchased from registry.', 'addf_giftr' );
		$this->template_base  = ADDF_GR_DIR;
		$this->template_html  = 'emails/product-purchase/admin/email-gr-html-template-admin.php';
		$this->template_plain = 'emails/product-purchase/admin/email-gr-plain-template.php';
	...
	public function get_default_subject() {
		return __( '[{site_title}]: ' . get_option( 'addf_gr_product_purchase_mail_subject_admin' ), 'addf_giftr' );
	}
	public function get_default_heading() {
		return __( 'Gift Registry : ' . get_option( 'addf_gr_product_purchase_mail_subject_admin_heading' ), 'woocommerce' );
	}
