...
class ADDF_GIFT_REGISTRY_CREATE_NEW_REG_WP_MAIL extends WC_Email {
	public function __construct() {
		$this->id             = 'addf_gr_create_new_wp_email_registrant';
		$this->title          = __( 'Gift Registry', 'addf_giftr' );
		$this->customer_email = true;
		$this->description    = __( 'This mail will send to registrant whenever a new registry is created.', 'addf_giftr' );
		$this->template_base  = ADDF_GR_DIR;
		$this->template_html  = 'emails/create-new-registry/registrant/email-gr-html-template.php';
		$this->template_plain = 'emails/create-new-registry/registrant/email-gr-plain-template.php';
	...
	public function get_default_subject() {
		return __( '[{site_title}]: ' . get_option( 'wc_settings_tab_gift_registry_notify_gift_registry_new_reg_site_title' ), 'addf_giftr' );
	}
	public function get_default_heading() {
		return __( 'Gift Registry : ' . get_option( 'wc_settings_tab_gift_registry_notify_gift_registry_new_reg_site_title_heading' ), 'woocommerce' );
	}
